...
import { Text, StyleSheet, FlatList, View, ScrollView, AsyncStorage, ActivityIndicator } from 'react-native';
...
class Categories extends Component {
  ...
  async componentWillMount(){
    try {
        ...
        const url = 'http://50.116.8.175/api/v1/service/rosefabrics/db?table=fabrics&where=category,' + cat;
